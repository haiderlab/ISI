...
for rep = 1:nr
    ...
    if GUIhandles.looper.randomflag %get(GUIhandles.looper.randomflag,'value')
...
bflag = 1; %get(GUIhandles.looper.blankflag,'value');
bPer = 0; %str2num(get(GUIhandles.looper.blankPeriod,'string'));
...
looperInfo.formula = GUIhandles.looper.formula; %get(GUIhandles.looper.formula,'string');
