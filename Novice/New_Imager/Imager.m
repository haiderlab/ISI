...
% Last Modified by GUIDE v2.5 01-Aug-2021 15:07:45
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global directionValue correctionValue secondaryIP


% Getting the direction
direction = get(handles.stimDirection,'SelectedObject');
correction = get(handles.correctionTag,'SelectedObject');

dir_Choosen = get(direction,'String');
if strcmp(dir_Choosen, 'Azimuth')
    directionValue = 1;
else
    directionValue = 0;
end
...
cor_Choosen = get(correction,'String');
if strcmp(cor_Choosen, 'Yes')
    correctionValue = 1;
else
    correctionValue = 0;
end

handles.numberOfRun = str2double(get(hObject,'String'));
global numberOfruns
% numberOfruns = handles.numberOfRun;

% Let's put simulator here!
...
function numberOfRun_Callback(hObject, eventdata, handles)
% hObject    handle to numberOfRun (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of numberOfRun as text
%        str2double(get(hObject,'String')) returns contents of numberOfRun as a double
% --- Executes during object creation, after setting all properties.
handles.numberOfRun = str2double(get(hObject,'String'));
global numberOfruns
numberOfruns = handles.numberOfRun;
...
function numberOfRun_CreateFcn(hObject, eventdata, handles)
% hObject    handle to numberOfRun (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
