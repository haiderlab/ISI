...
Pstate.param{17} = {'phase'         'float'        0       0                'deg'};
Pstate.param{18} = {'separable'   'int'     0       0                'bit'};
Pstate.param{19} = {'st_profile'  'string'   'sin'       0                ''};
Pstate.param{20} = {'s_freq'      'float'      1      -1                 'cyc/deg'};
Pstate.param{21} = {'s_profile'   'string'   'sin'       0                ''};
Pstate.param{22} = {'s_duty'      'float'   0.5       0                ''};
Pstate.param{23} = {'t_profile'   'string'   'sin'       0                ''};
Pstate.param{24} = {'t_duty'      'float'   0.5       0                ''};
Pstate.param{25} = {'t_period'    'int'       20       0                'frames'};
