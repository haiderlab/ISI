...
g_ar = double(ims{1});
load('../../../Data/ISI/Animal_Testing/Mouse_4_A19014/08_12/2/000.mat');
...
%map = rad2deg(map_1);
figure; imagesc((rad2deg(map_1)*206/360)+44); colormap jet; colorbar  
