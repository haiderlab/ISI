function [area,locvec] = ISIanalysis_new(ISIdata,FPS)
...
outputF = ISIpreprocess_new(loc_GL,[loc_RL '000.mat'],limit_loc_fw,plotbit,savebit,'none',FPS);%Average out 1 run to 1 period
outputB = ISIpreprocess_new(loc_GL,[loc_RL '001.mat'],limit_loc_bw,plotbit,savebit,outputF.g_im,FPS);
